...
<br>
The bottom link has a special 'invite' token embedded in it, which adds you to the workspace. If you're not connected, **do this now**. TAs: stop. Wait. Give students time to do this.
---
...
* click "Copy Project" next to **Workshop 04**
* now we're going to alt tab and do this together ... !

<br>
(if you'd rather download the file to your own computer, you can <a href="Workshop04.Rmd">do that</a>)
...
There's also an assignment on WeBWorK called "PracticeProblems3"
